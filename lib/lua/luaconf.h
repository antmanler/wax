 ...
 */
  ...
  #endif
#endif /* if defined(lua_c) || defined(luaall_c) */
...
#endif /* if defined(LUA_NUMBER_DOUBLE) && !defined(LUA_ANSI) && !defined(__SSE2__) && (defined(__i386) || defined(_M_IX86) || defined(__i386__)) */
 ...
 */
  ...
  #endif
#endif /* if defined(loslib_c) || defined(luaall_c) */
